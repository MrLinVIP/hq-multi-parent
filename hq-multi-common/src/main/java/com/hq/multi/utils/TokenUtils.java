...
import com.hq.multi.constant.Constant;
...
public class TokenUtils {
     ...
     * @param key    生成摘要的 密码
     */
    public static String createToken(String userId, String username, String key) {
        return createToken(userId, username, key, expire);
    }

    public static String createToken(String userId, String username, String key, Long expires) {
        try {
            return JWT.create()
                    // 签发时间
            ...
            throw new MultiException("TOKEN创建失败：" + e.getMessage());
        }
    }
