...
import com.hq.multi.anno.ExcelAttribute;
import com.hq.multi.constant.StatusCode;
import com.hq.multi.exception.MultiException;
...
public class ExcelUtil<T1, T2> implements Serializable {
    ...
    public List<T1> getExcelToList(String sheetName, InputStream input) {
        ...
        try {
            ...
            throw new MultiException(StatusCode.IMPORT_EXCEL_EXCEPTION);
        }
        return list;
    }

    private T1 getExcelData(XSSFSheet sheet, Map<Integer, Field> fieldsMap, int i) throws InstantiationException, IllegalAccessException, ParseException {
        ...
        while (cells.hasNext()) {
            ...
            if (String.class == fieldType) {
                ...
                field.set(entity, org.apache.commons.lang3.time.DateUtils.parseDate(c));
...
//                HSSFSheet sheet = workbook.createSheet(sheetName);
            ...
            throw new MultiException(StatusCode.EXPORT_EXCEL_EXCEPTION);
        }

    }

    private void setHeadField(List<Field> fields, XSSFSheet sheet, XSSFRow row, XSSFFont font, XSSFCellStyle cellStyle) {
        XSSFCell cell;
    ...
    private void setData(List<T1> list, int sheetSize, List<Field> fields, XSSFWorkbook workbook, int listSize, int index, int startRow, XSSFSheet sheet, XSSFFont newFont, XSSFCellStyle newCellStyle) throws IllegalAccessException {
        XSSFFont font;
    ...
    private void setCount(List<Field> fields, XSSFSheet sheet, Object countObj) {
        T2 obj = (T2) countObj;
        ...
        fields.forEach(y -> {
            ...
            if ("A".equals(b.column())) {
                XSSFCell sumCell = lastRow.createCell(getExcelCol(b.column()));
            ...
            f.forEach(x -> {
                ...
                try {
                    if (a.column().equals(b.column())) {
                        XSSFCell sumCell = lastRow.createCell(getExcelCol(a.column()));
